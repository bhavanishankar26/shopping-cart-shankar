pipeline {
    ...
    //     }
          ...
          stage ("Kube Deploy") {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'terraform-eks-demo', contextName: 'arn:aws:eks:ap-south-1:471581286766:cluster/terraform-eks-demo', credentialsId: 'credentialsId', namespace: 'default', restrictKubeConfigAccess: false, serverUrl: 'https://D1078F00B950512D183E77A4F71FE8C6.gr7.ap-south-1.eks.amazonaws.com') {
